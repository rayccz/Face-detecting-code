...
#for filename in os.listdir('/home/capstone/pipeline/AdaBoost_to_CNN/detected_faces'):
	import caffe
	import numpy as np
	root='/home/capstone/cnn_train_models/train_front/'   #根目录
	deploy=root + 'face_deploy.prototxt'    #deploy文件
	caffe_model='/home/capstone/cnn_train_models/model_front/face_iter_1086450.caffemodel'   #训练好的 caffemodel
	img='/home/capstone/pipeline/AdaBoost_to_CNN/detected_faces_front/picture'+pic_label+'_'+str(i)+'.jpg' #随机找的一张待测图片
