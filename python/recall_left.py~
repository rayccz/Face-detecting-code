...
root='/home/capstone/cnn_train_models/train_left/'
deploy=root + 'face_deploy2.prototxt'
caffe_model='/home/capstone/cnn_train_models/model_left/face_iter_1038840.caffemodel'
...
def main(argv):
    ...
    i=0
    j=0
    #f=open('/home/capstone/pipeline/face_result_left.txt','a')
    f=open('/home/capstone/pipeline/AdaBoost_to_CNN/faces_log_left.txt','r+')
    flist=f.readlines()
	...
	if order==1:
		...
		flist[j]=str(args.output_file)+strii
        i=i+1
    f=open('/home/capstone/pipeline/AdaBoost_to_CNN/faces_log_left.txt','w+')
    f.writelines(flist)
