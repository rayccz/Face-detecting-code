...
root='/home/capstone/cnn_train_models/train_front/'
deploy=root + 'face_deploy2.prototxt'
caffe_model='/home/capstone/cnn_train_models/model_front/face_iter_1086450.caffemodel'
...
def main(argv):
    ...
    i=0
    #f=open('/home/capstone/pipeline/face_result_front.txt','a')
    f=open('/home/capstone/pipeline/AdaBoost_to_CNN/faces_log_front.txt','r+')
    flist=f.readlines()
    j=0
	...
	if order==1:
		...
		#print flist[j]
        i=i+1
    f=open('/home/capstone/pipeline/AdaBoost_to_CNN/faces_log_front.txt','w+')
    f.writelines(flist)
